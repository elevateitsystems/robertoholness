          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-5">
              <Link
                ...
                className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center hover:bg-secondary hover:text-white transition-all"
              >
                <FacebookIcon />
              </Link>
              <Link
          ...
          <div>
            ...
            <ul className="space-y-3 text-base">
              <li className="flex justify-between border-b border-white/5 pb-2">
                <span>Mon - Fri</span>{" "}
                <span className="text-white">9:00 - 7:00</span>
              </li>
              <li className="flex justify-between border-b border-white/5 pb-2">
                <span>Saturday</span>{" "}
                <span className="text-white">9:00 - 6:00</span>
              </li>
              <li className="flex justify-between border-b border-white/5 pb-2">
                <span>Sunday</span>{" "}
                <span className="text-white">10:00 - 5:00</span>
              </li>
            </ul>
          </div>
        </div>
