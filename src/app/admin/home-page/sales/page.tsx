...
export default function AdminSalesPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const updated = {
      ...
      discountText: activeModal === "text" ? discountText : salesData.discountText,
      ...
      <div className="bg-gray-100 p-8 rounded-xl border border-gray-200 shadow-sm relative overflow-hidden">
        ...
        <div className="w-full bg-white rounded-xl shadow-2xl overflow-hidden border border-gray-200 flex flex-col md:flex-row relative">
          ...
          >
            ...
            <Button disabled className="border border-white/50 text-white hover:bg-white hover:text-black bg-transparent px-8 py-3 text-xs font-bold tracking-widest uppercase cursor-default opacity-85">
              Shop Now
            </Button>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-2xl max-w-lg w-full overflow-hidden border border-gray-100">
            ...
            <div className="bg-gray-50 px-6 py-4 border-b border-gray-100 flex items-center justify-between">
              <h3 className="text-base font-bold text-gray-900">
                {activeModal === "text" ? "Update Sales Details" : "Replace Sales Image"}
              </h3>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              {activeModal === "text" && (
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-1">Title (Use Space for styled suffix)</label>
                    <input 
                      type="text" 
                      value={title} 
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-1">Discount Text</label>
                    <input 
                      type="text" 
                      value={discountText} 
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-1">Coupon Code Text</label>
                    <input 
                      type="text" 
                      value={codeText} 
              ...
              {activeModal === "image" && (
                <div className="space-y-4">
                  <label className="block text-sm font-semibold text-gray-700">Choose Image</label>
                  <div className="flex flex-col items-center justify-center border-2 border-dashed border-gray-300 rounded-lg p-6 hover:border-blue-500 bg-gray-50/50">
                    {imagePreview ? (
                      <img src={imagePreview} alt="Preview" className="h-32 w-auto object-contain mb-4 rounded" />
                    ) : null}
