...
export default function AdminServiceBannerPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    localStorage.setItem("banner_service", JSON.stringify(updated));
    setBannerData(updated);
    
    setTimeout(() => {
      setSaving(false);
      toast.success("Services Banner Hero updated successfully!");
  ...
  return (
    <div className="space-y-8">
      <PageHeader 
        title="Manage Services Banner" 
        description="Click the edit icons on the preview below to update the Service Page hero headings, badges, and breadcrumb descriptions."
      />
      ...
      <div className="bg-gray-100 p-8 rounded-xl border border-gray-200 shadow-sm relative overflow-hidden">
        <div className="mb-4 flex items-center justify-between">
          ...
          <span className="text-xs text-gray-400">PageHero Component (Services Page)</span>
        </div>
      ...
      <Modal
        ...
        title="Update Services Banner Hero"
