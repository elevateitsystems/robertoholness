...
const contactInfo = [
  {
    icon: MapPinIcon,
    title: "Address",
    text: "3301 Menaul Blvd Suite 10 Albuquerque",
    color: "from-primary to-warm-orange",
  },
  {
    icon: PhoneIcon,
    title: "Phone",
    text: "505-990-0099",
    color: "from-secondary to-deep-teal",
  },
  {
    icon: MailIcon,
    title: "Email",
    text: "info@simplydiegos.com",
    color: "from-accent-green to-[#6BA033]",
  },
  {
    icon: ClockIcon,
    title: "Store Hours",
    text: "Mon - Fri: 9am - 7pm\nSat: 9am - 6pm\nSun: 10am - 6pm",
    color: "from-warm-orange to-primary",
    ...
    <div className="flex flex-col w-full">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[var(--warm-cream)] via-[var(--warm-peach)] to-[var(--warm-cream)] py-24 border-b border-primary/10">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          >
            Have a question about nutrition? Need to book a wash? Our team of
            pet experts is here to help you and your furry friends.
          </motion.p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
              ...
              <div className="space-y-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                  {contactInfo.map((item, i) => (
                    ...
                    >
                      <div
                        className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${item.color} text-white flex items-center justify-center shrink-0 shadow-lg group-hover:scale-110 transition-transform`}
                      >
                        <item.icon />
                      </div>
                      <div>
                        {item.href ? (
                          ...
                          <h4 className="text-lg font-black text-secondary mb-1">
                            {item.title}
                          </h4>
                        )}
                        <p className="text-secondary/60 leading-relaxed whitespace-pre-line">
                          {item.text}
                        </p>
                      </div>
                    </motion.div>
            ...
            >
              ...
              <div className="relative bg-white/90 backdrop-blur-sm p-10 md:p-14 rounded-3xl border border-primary/10 shadow-xl overflow-hidden">
                ...
                <h2 className="text-4xl font-heading font-black text-secondary mb-10 relative z-10">
                  Send a Message
                </h2>
                <form
                ...
                >
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                    <div className="space-y-3">
                      ...
                      <input
                        type="text"
                        className="w-full h-14 px-6 rounded-xl border-2 border-primary/15 bg-[var(--warm-cream)]/50 focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary/30 transition-all shadow-sm"
                  ...
                  <div className="space-y-3">
                    ...
                    <textarea
                      className="w-full h-40 p-6 rounded-xl border-2 border-primary/15 bg-[var(--warm-cream)]/50 focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary/30 transition-all resize-none shadow-sm"
